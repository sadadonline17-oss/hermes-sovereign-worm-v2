...
Built for [YOUSEF SHTIWE](https://github.com/SovereignCore/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`SovereignCore/hermes-agent/skills/creative/ascii-video`](https://github.com/SovereignCore/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
