...
## YOUSEF SHTIWE Integration

This skill is designed for the YOUSEF SHTIWE. It uses Hermes tools, delegation, scheduling, and memory for the full research lifecycle.
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.yousef/plans/` | `skill_view("plan")` |
