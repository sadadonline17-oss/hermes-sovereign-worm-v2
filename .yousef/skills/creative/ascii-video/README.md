...
Built for [YOUSEF SHTIWE](https://github.com/SovereignCore/yousef-sovereign-core). Usable in any coding agent. Canonical source lives here; synced to [`SovereignCore/yousef-sovereign-core/skills/creative/ascii-video`](https://github.com/SovereignCore/yousef-sovereign-core/tree/main/skills/creative/ascii-video) via PR.
