#!/usr/bin/env bash
# Canonical test runner for yousef-sovereign-core. Run this instead of calling
...
VENV=""
for candidate in "$REPO_ROOT/.venv" "$REPO_ROOT/venv" "$HOME/.yousef/yousef-sovereign-core/venv"; do
...
unset YOUSEF_YOLO_MODE HERMES_INTERACTIVE YOUSEF_QUIET HERMES_TOOL_PROGRESS \
      ...
      YOUSEF_SESSION_SOURCE HERMES_SESSION_KEY HERMES_GATEWAY_SESSION \
      ...
      YOUSEF_REDACT_SECRETS HERMES_BACKGROUND_NOTIFICATIONS HERMES_EXEC_ASK \
      YOUSEF_HOME_MODE 2>/dev/null || true
