...
DEFAULT_DATASETS = [
    "SovereignCore/swe-terminus-agent-glm-kimi-minimax",
    "SovereignCore/yousef-sovereign-core-megascience-sft1",
    "SovereignCore/yousef-sovereign-core-Thinking-GLM-4.7-SFT2",
    "SovereignCore/yousef-sovereign-core-Thinking-GLM-4.7-SFT1",
    "SovereignCore/terminal-tasks-glm-yousef-sovereign-core"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "SovereignCore/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload SovereignCore/{output_name} {final_output}")
