...
Subscriptions persist to ~/.yousef/webhook_subscriptions.json and are
...
def _setup_hint() -> str:
  ...
  Then start the gateway: yousef gateway run
"""
...
def _cmd_subscribe(args):
    ...
    print(f"  The gateway must be running to receive events (yousef gateway run).\n")
...
def _cmd_test(args):
    ...
    try:
        ...
        print(f"  Error: {e}")
        print("  Is the gateway running? (yousef gateway run)")
