...
from yousef_shtiwe_cli_core.config import get_hermes_home, get_config_path, load_config, save_config
...
def _print_migration_report(report: dict, dry_run: bool):
    ...
    if dry_run:
        ...
        if skipped_keys:
            ...
            print_info("  yousef config set OPENROUTER_API_KEY sk-or-v1-...")
