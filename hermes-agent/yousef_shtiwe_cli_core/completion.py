...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# YOUSEF SHTIWE bash completion
# Add to ~/.bashrc:
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        ...
        "    echo default",
        "    if test -d $HOME/.yousef/profiles",
        "        ls $HOME/.yousef/profiles 2>/dev/null",
        "    end",
        "end",
        "",
