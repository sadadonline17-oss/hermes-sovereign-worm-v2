...
from yousef_shtiwe_cli_core import auth as auth_mod
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        from yousef_shtiwe_cli_core.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if configured_mode and _provider_supports_explicit_api_mode(provider, configured_provider):
            ...
            from yousef_shtiwe_cli_core.models import opencode_model_api_mode
...
def resolve_runtime_provider(
    *,
    ...
    if provider == "bedrock":
        ...
        from yousef_shtiwe_cli_core.config import load_config as _load_bedrock_config
