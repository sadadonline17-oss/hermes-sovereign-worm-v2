...
into prompt_toolkit's event loop. Each function takes the YousefCLI instance
...
from yousef_shtiwe_cli_core.banner import cprint, _DIM, _RST
from yousef_shtiwe_cli_core.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.yousef/.env and never exposed to the model.
    """
