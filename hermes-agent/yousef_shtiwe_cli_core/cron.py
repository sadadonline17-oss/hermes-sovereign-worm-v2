...
def cron_list(show_all: bool = False):
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: yousef gateway install", Colors.DIM))
        print(color("                    sudo yousef gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    yousef gateway install    # Install as a user service")
        print("    sudo yousef gateway install --system  # Linux servers: boot-time system service")
        print("    yousef gateway            # Or run in foreground")
