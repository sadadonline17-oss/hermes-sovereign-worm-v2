...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active YOUSEF_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.yousef``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "yousef").
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        ``hermes_home`` is the active YOUSEF_HOME directory path.
