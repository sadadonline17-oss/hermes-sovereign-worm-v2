    ...
    if provider == "anthropic":
        ...
        for source_name, creds in (
            ...
            if creds and creds.get("accessToken"):
                ...
                try:
                    from yousef_shtiwe_cli_core.auth import is_source_suppressed
        ...
        try:
            from yousef_shtiwe_cli_core.auth import resolve_qwen_runtime_credentials
        ...
        if not (isinstance(tokens, dict) and tokens.get("access_token")):
            try:
                from yousef_shtiwe_cli_core.auth import _import_codex_cli_tokens, _save_codex_tokens
                cli_tokens = _import_codex_cli_tokens()
                if cli_tokens:
