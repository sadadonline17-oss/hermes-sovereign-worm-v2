...
def build_plan_path(
    ...
    *,
    ...
    return Path(".yousef") / "plans" / f"{timestamp}-{slug}.md"
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.yousef.config``
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    """Scan ~/.yousef/skills/ and return a mapping of /command -> skill info.
