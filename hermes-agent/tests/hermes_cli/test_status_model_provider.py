"""Tests for yousef_shtiwe_cli_core.status model/provider display."""
...
def test_show_status_displays_configured_dict_model_and_provider_label(monkeypatch, capsys, tmp_path):
    from yousef_shtiwe_cli_core import status as status_mod
...
def test_show_status_reports_managed_nous_features(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("yousef_shtiwe_cli_core.status.managed_nous_tools_enabled", lambda: True)
    from yousef_shtiwe_cli_core import status as status_mod
...
def test_show_status_hides_nous_subscription_section_when_feature_flag_is_off(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("yousef_shtiwe_cli_core.status.managed_nous_tools_enabled", lambda: False)
    from yousef_shtiwe_cli_core import status as status_mod
