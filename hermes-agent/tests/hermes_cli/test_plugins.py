"""Tests for the Hermes plugin system (yousef_shtiwe_cli_core.plugins)."""
...
from yousef_shtiwe_cli_core.plugins import (
    ENTRY_POINTS_GROUP,
    VALID_HOOKS,
    LoadedPlugin,
    PluginContext,
...
class TestPluginDiscovery:
    ...
    def test_discover_user_plugins(self, tmp_path, monkeypatch):
        """Plugins in ~/.yousef/plugins/ are discovered."""
        plugins_dir = tmp_path / "hermes_test" / "plugins"
        _make_plugin_dir(plugins_dir, "hello_plugin")
        monkeypatch.setenv("YOUSEF_HOME", str(tmp_path / "hermes_test"))
    ...
    def test_discover_project_plugins(self, tmp_path, monkeypatch):
        ...
        plugins_dir = project_dir / ".yousef" / "plugins"
...
class TestPluginHooks:
    ...
    def test_invalid_hook_name_warns(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="yousef_shtiwe_cli_core.plugins"):
            mgr = PluginManager()
            mgr.discover_and_load()
...
class TestPreToolCallBlocking:
    ...
    def test_block_message_returned_for_valid_directive(self, monkeypatch):
        monkeypatch.setattr(
            "yousef_shtiwe_cli_core.plugins.invoke_hook",
...
class TestPluginToolVisibility:
    ...
    def test_plugin_tools_in_definitions(self, tmp_path, monkeypatch):
        ...
        import yousef_shtiwe_cli_core.plugins as plugins_mod
...
class TestPluginCommands:
    ...
    def test_get_plugin_command_handler_found(self):
        ...
        with patch("yousef_shtiwe_cli_core.plugins._plugin_manager", mgr):
...
class TestPluginDispatchTool:
    ...
    def test_dispatch_tool_calls_registry(self):
        ...
        with patch("yousef_shtiwe_cli_core.plugins.PluginContext.dispatch_tool.__module__", "yousef_shtiwe_cli_core.plugins"):
