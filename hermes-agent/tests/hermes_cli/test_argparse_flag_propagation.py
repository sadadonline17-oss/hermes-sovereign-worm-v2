...
def _build_parser():
    ...
    """
    parser = argparse.ArgumentParser(prog="yousef")
...
class TestYoloEnvVar:
    """Verify --yolo sets YOUSEF_YOLO_MODE regardless of flag position.
    ...
    def test_yolo_before_chat_sets_env(self):
        ...
        assert os.environ.get("YOUSEF_YOLO_MODE") == "1"
    ...
    def test_no_yolo_no_env(self):
        ...
        self._simulate_cmd_chat_yolo_check(args)
        assert os.environ.get("YOUSEF_YOLO_MODE") is None
