...
def _run_switch(raw_input: str, current_provider: str = "openrouter") -> str:
    ...
    with patch("yousef_shtiwe_cli_core.model_switch.resolve_alias", return_value=None), \
         patch("yousef_shtiwe_cli_core.model_switch.list_provider_models", return_value=[]), \
         patch("yousef_shtiwe_cli_core.runtime_provider.resolve_runtime_provider",
               return_value={"api_key": "test", "base_url": "", "api_mode": "chat_completions"}), \
         patch("yousef_shtiwe_cli_core.models.validate_requested_model", return_value=_MOCK_VALIDATION), \
