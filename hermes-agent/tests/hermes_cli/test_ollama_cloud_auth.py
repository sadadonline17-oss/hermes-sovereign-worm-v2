...
class TestDirectAliases:
    ...
    def test_direct_alias_loaded_from_config(self, monkeypatch):
        ...
        from yousef_shtiwe_cli_core.model_switch import _load_direct_aliases
    ...
    def test_direct_alias_resolved_before_catalog(self, monkeypatch):
        ...
        from yousef_shtiwe_cli_core.model_switch import DirectAlias, resolve_alias
        import yousef_shtiwe_cli_core.model_switch as ms
...
class TestModelSwitchPersistence:
    ...
    def test_model_switch_result_fields(self):
        ...
        from yousef_shtiwe_cli_core.model_switch import ModelSwitchResult
...
class TestModelTabCompletion:
    ...
    def test_model_completions_yields_direct_aliases(self, monkeypatch):
        ...
        from yousef_shtiwe_cli_core.commands import SlashCommandCompleter
        from yousef_shtiwe_cli_core.model_switch import DirectAlias
        import yousef_shtiwe_cli_core.model_switch as ms
...
class TestSwitchModelDirectAliasOverride:
    ...
    def test_switch_model_uses_alias_base_url(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "yousef_shtiwe_cli_core.runtime_provider.resolve_runtime_provider",
            lambda requested: {"api_key": "", "base_url": "", "api_mode": "openai_compat", "provider": "custom"},
        )

        monkeypatch.setattr("yousef_shtiwe_cli_core.models.validate_requested_model",
            lambda *a, **kw: {"accepted": True, "persist": True, "recognized": True, "message": None})
        monkeypatch.setattr("yousef_shtiwe_cli_core.models.opencode_model_api_mode",
