"""Tests for yousef_shtiwe_cli_core.doctor."""
...
import yousef_shtiwe_cli_core.doctor as doctor
import yousef_shtiwe_cli_core.gateway as gateway_cli
from yousef_shtiwe_cli_core import doctor as doctor_mod
from yousef_shtiwe_cli_core.doctor import _has_provider_env_config
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor_mod, "YOUSEF_HOME", hermes_home)
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_hermes_home(self, tmp_path, provider=""):
        """Create a minimal YOUSEF_HOME with config.yaml."""
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        monkeypatch.setattr(doctor_mod, "YOUSEF_HOME", home)
        ...
        try:
            from yousef_shtiwe_cli_core import auth as _auth_mod
