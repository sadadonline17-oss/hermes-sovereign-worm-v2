"""Tests for MCP tools interactive configuration in yousef_shtiwe_cli_core.tools_config."""

from types import SimpleNamespace
from unittest.mock import MagicMock, patch

from yousef_shtiwe_cli_core.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "yousef_shtiwe_cli_core.curses_ui.curses_checklist"
_SAVE = "yousef_shtiwe_cli_core.tools_config.save_config"
