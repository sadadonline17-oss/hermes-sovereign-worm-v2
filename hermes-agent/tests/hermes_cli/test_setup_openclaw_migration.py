...
class TestOfferOpenclawMigration:
    ...
    def test_skips_when_no_openclaw_dir(self, tmp_path):
        ...
        with patch("yousef_shtiwe_cli_core.setup.Path.home", return_value=tmp_path):
            assert setup_mod._offer_openclaw_migration(tmp_path / ".yousef") is False
    ...
    def test_skips_when_migration_script_missing(self, tmp_path):
        ...
        openclaw_dir.mkdir()
        with (
            patch("yousef_shtiwe_cli_core.setup.Path.home", return_value=tmp_path),
