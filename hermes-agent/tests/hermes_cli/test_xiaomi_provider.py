...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_models_py(self):
        from yousef_shtiwe_cli_core.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
        from yousef_shtiwe_cli_core.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from yousef_shtiwe_cli_core.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from yousef_shtiwe_cli_core.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
...
class TestXiaomiDoctor:
    """Verify yousef doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from yousef_shtiwe_cli_core.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from yousef_shtiwe_cli_core.providers import HERMES_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = HERMES_OVERLAYS["xiaomi"]
