"""Tests for yousef_shtiwe_cli_core/skills_config.py and skills_tool disabled filtering."""
import pytest
...
class TestSaveDisabledSkills:
    @patch("yousef_shtiwe_cli_core.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from yousef_shtiwe_cli_core.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("yousef_shtiwe_cli_core.config.load_config")
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from yousef_shtiwe_cli_core.skills_config import _get_categories
        skills = [
