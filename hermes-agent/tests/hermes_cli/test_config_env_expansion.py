...
import os
import pytest
from yousef_shtiwe_cli_core.config import _expand_env_vars, load_config
...
class TestLoadConfigExpansion:
    def test_load_config_expands_env_vars(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("yousef_shtiwe_cli_core.config.get_config_path", lambda: config_file)
