"""Tests for yousef_shtiwe_cli_core/completion.py — shell completion script generation."""
...
from yousef_shtiwe_cli_core.completion import _walk, generate_bash, generate_zsh, generate_fish
...
def _make_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(prog="yousef")
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
        from yousef_shtiwe_cli_core.main import _coalesce_session_name_args
...
class TestProfileCompletion:
    ...
    def test_bash_has_profiles_helper(self):
        ...
        assert 'profiles_dir="$HOME/.yousef/profiles"' in out
    ...
    def test_zsh_has_profiles_helper(self):
        out = generate_zsh(_make_parser())
        assert "_hermes_profiles()" in out
        assert "$HOME/.yousef/profiles" in out
