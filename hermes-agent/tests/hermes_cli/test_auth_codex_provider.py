"""Tests for Codex auth — tokens stored in Hermes auth store (~/.yousef/auth.json)."""
...
def test_resolve_codex_runtime_credentials_refreshes_expiring_token(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("yousef_shtiwe_cli_core.auth._refresh_codex_auth_tokens", _fake_refresh)
...
def test_refresh_codex_auth_tokens_writes_back_to_cli(tmp_path, monkeypatch):
    ...
    from yousef_shtiwe_cli_core.auth import _refresh_codex_auth_tokens
    ...
    monkeypatch.setattr("yousef_shtiwe_cli_core.auth.refresh_codex_oauth_pure", lambda *a, **kw: {
