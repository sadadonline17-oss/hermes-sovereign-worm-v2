...
"""
    ...
    assert "Tyler Williams > Active Projects: YOUSEF SHTIWE" in entries
...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    #                      tell the user to *review* ~/.yousef/config.yaml;
