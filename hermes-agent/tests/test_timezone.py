"""
Tests for timezone support (yousef_time module + integration points).
...
def _reset_yousef_time_cache():
    """Reset the yousef_time module cache (replacement for removed reset_cache)."""
    yousef_time._cached_tz = None
    yousef_time._cached_tz_name = None
    yousef_time._cache_resolved = False


# =========================================================================
# yousef_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="yousef_time"):
            result = yousef_time.now()
...
class TestCodeExecutionTZ:
    ...
    def test_yousef_timezone_not_leaked_to_child(self):
