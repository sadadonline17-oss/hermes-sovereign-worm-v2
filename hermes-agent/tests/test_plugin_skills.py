...
- yousef_shtiwe_cli_core/plugins register_skill API + registry
...
class TestPluginSkillRegistry:
    ...
    def pm(self, monkeypatch):
        from yousef_shtiwe_cli_core import plugins as plugins_mod
        from yousef_shtiwe_cli_core.plugins import PluginManager
...
class TestPluginContextRegisterSkill:
    ...
    def ctx(self, tmp_path, monkeypatch):
        from yousef_shtiwe_cli_core import plugins as plugins_mod
        from yousef_shtiwe_cli_core.plugins import PluginContext, PluginManager, PluginManifest
...
class TestSkillViewPluginGuards:
    ...
    def test_disabled_plugin(self, tmp_path, monkeypatch):
        ...
        self._reg(tmp_path, "---\nname: foo\n---\nBody.\n")
        monkeypatch.setattr("yousef_shtiwe_cli_core.plugins._get_disabled_plugins", lambda: {"myplugin"})
