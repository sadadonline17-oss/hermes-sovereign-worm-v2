...
def _enable_managed_nous_tools(monkeypatch):
    ...
    yousef_shtiwe_cli_core.auth and yousef_shtiwe_cli_core.models — so the function body returns True.
    """
    monkeypatch.setattr("yousef_shtiwe_cli_core.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("yousef_shtiwe_cli_core.models.check_nous_free_tier", lambda: False)
