...
3. YousefShtiweBaseEnv wires the selected parser into ServerManager correctly

These tests verify the contract between yousef-sovereign-core's environments/ code
...
class TestManagedServerAPI:
    """Test that ManagedServer's API matches what yousef-sovereign-core expects."""
...
class TestParserCompatibility:
    """Test that yousef-sovereign-core's parsers match ManagedServer's expectations."""
