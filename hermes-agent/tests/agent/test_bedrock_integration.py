...
Note: Tests that import ``yousef_shtiwe_cli_core.auth`` or ``yousef_shtiwe_cli_core.runtime_provider``
...
class TestResolveProvider:
    ...
    def test_explicit_bedrock_resolves(self, monkeypatch):
        ...
        from yousef_shtiwe_cli_core.auth import resolve_provider
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("yousef_shtiwe_cli_core.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("yousef_shtiwe_cli_core.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("yousef_shtiwe_cli_core.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("yousef_shtiwe_cli_core.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("yousef_shtiwe_cli_core.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("yousef_shtiwe_cli_core.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    """Verify bedrock is wired into yousef_shtiwe_cli_core/providers.py."""

    def test_bedrock_alias_in_providers(self):
        from yousef_shtiwe_cli_core.providers import ALIASES
    ...
    def test_bedrock_transport_mapping(self):
        from yousef_shtiwe_cli_core.providers import TRANSPORT_TO_API_MODE
...
class TestPackaging:
    ...
    def test_bedrock_in_all_extra(self):
        ...
        assert '"yousef-sovereign-core[bedrock]"' in content
