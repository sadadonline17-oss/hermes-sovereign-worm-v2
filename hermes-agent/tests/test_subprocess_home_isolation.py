...
See: https://github.com/SovereignCore/yousef-sovereign-core/issues/4426
"""
...
class TestGetSubprocessHome:
    ...
    def test_returns_none_when_hermes_home_unset(self, monkeypatch):
        ...
        from yousef_constants import get_subprocess_home
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("YOUSEF_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("YOUSEF_HOME", str(base / "beta"))
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from yousef_shtiwe_cli_core.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from yousef_shtiwe_cli_core.profiles import create_profile
