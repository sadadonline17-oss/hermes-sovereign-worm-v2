"""Tests for _setup_feishu() in yousef_shtiwe_cli_core/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("yousef_shtiwe_cli_core.gateway.save_env_value", side_effect=mock_save), \
         patch("yousef_shtiwe_cli_core.gateway.get_env_value", side_effect=mock_get), \
         patch("yousef_shtiwe_cli_core.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("yousef_shtiwe_cli_core.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("yousef_shtiwe_cli_core.gateway.prompt", side_effect=prompt_responses), \
         patch("yousef_shtiwe_cli_core.gateway.print_info"), \
         patch("yousef_shtiwe_cli_core.gateway.print_success"), \
         patch("yousef_shtiwe_cli_core.gateway.print_warning"), \
         patch("yousef_shtiwe_cli_core.gateway.print_error"), \
         patch("yousef_shtiwe_cli_core.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from yousef_shtiwe_cli_core.gateway import _setup_feishu
        _setup_feishu()
