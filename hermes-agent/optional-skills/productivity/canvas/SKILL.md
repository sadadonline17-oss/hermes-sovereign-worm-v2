...
4. Name the token (e.g., "YOUSEF SHTIWE"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.yousef/.env`:
...
```bash
CANVAS="python $YOUSEF_HOME/skills/productivity/canvas/scripts/canvas_api.py"
