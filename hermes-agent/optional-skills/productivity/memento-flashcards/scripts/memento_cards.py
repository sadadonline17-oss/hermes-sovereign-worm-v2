...
Data file: $YOUSEF_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_YOUSEF_HOME = Path(os.environ.get("YOUSEF_HOME", Path.home() / ".yousef"))
DATA_DIR = _YOUSEF_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
