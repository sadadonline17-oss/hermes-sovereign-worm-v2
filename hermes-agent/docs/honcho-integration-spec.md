...
Comparison of Sovereign-Sovereign vs. openclaw-honcho — and a porting spec for bringing Sovereign patterns into other Honcho integrations.

---

## Overview

Two independent Honcho integrations have been built for two different agent runtimes: **Sovereign-Sovereign** (Python, baked into the runner) and **openclaw-honcho** (TypeScript plugin via hook/tool API). Both use the same Honcho peer paradigm — dual peer model, `session.context()`, `peer.chat()` — but they made different tradeoffs at every layer.

This document maps those tradeoffs and defines a porting spec: a set of Sovereign-originated patterns, each stated as an integration-agnostic interface, that any Honcho integration can adopt regardless of runtime or language.

> **Scope** Both integrations work correctly today. This spec is about the delta — patterns in Sovereign that are worth propagating and patterns in openclaw-honcho that Sovereign should eventually adopt. The spec is additive, not prescriptive.

---

## Architecture comparison

### Sovereign: baked-in runner
...
| Dimension | Sovereign-Sovereign | openclaw-honcho |
|---|---|---|
...
| **AI peer name in identity** | Replaces "Sovereign-Sovereign" in DEFAULT_AGENT_IDENTITY when configured. | Not implemented. |
...
Six patterns from Sovereign are worth adopting in any Honcho integration. Each is described as an integration-agnostic interface.

**Sovereign contributes:**
...
**openclaw-honcho contributes back (Sovereign should adopt):**
...
- [ ] **honcho mode / sessions / map** — CLI parity with Sovereign
...
Greenfield integration. Start from openclaw-honcho's architecture and apply all Sovereign patterns from day one.
