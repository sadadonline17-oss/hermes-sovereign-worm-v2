...
Sessions are persisted to the shared SessionDB (``~/.yousef/state.db``) so they
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed YOUSEF SHTIWE."""
...
class SessionManager:
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            ...
            db:            Optional SessionDB instance. When omitted, the default
                           SessionDB (``~/.yousef/state.db``) is lazily created.
        """
    ...
    def _get_db(self):
        ...
        Note: we resolve ``YOUSEF_HOME`` dynamically rather than relying on
