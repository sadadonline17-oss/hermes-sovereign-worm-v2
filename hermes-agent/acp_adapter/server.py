"""ACP agent server — exposes YOUSEF SHTIWE via the Agent Client Protocol."""
...
try:
    from yousef_shtiwe_cli_core import __version__ as HERMES_VERSION
except Exception:
...
class HermesACPAgent(acp.Agent):
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name="yousef-sovereign-core", version=HERMES_VERSION),
    ...
    def _cmd_model(self, args: str, state: SessionState) -> str:
        ...
        try:
            from yousef_shtiwe_cli_core.models import parse_model_input, detect_provider_for_model
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"YOUSEF SHTIWE v{HERMES_VERSION}"
