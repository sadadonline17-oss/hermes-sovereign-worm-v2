...
## 12. Status Display (`yousef_shtiwe_cli_core/status.py`)
...
## 13. Gateway Setup Wizard (`yousef_shtiwe_cli_core/gateway.py`)
...
grep -r "telegram\|discord\|whatsapp\|slack" gateway/ tools/ agent/ cron/ yousef_shtiwe_cli_core/ toolsets.py \
  --include="*.py" -l | sort -u
