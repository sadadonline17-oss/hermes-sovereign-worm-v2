...
- GET  /v1/models                  — lists yousef-sovereign-core as an available model
...
AnythingLLM, NextChat, ChatBox, etc.) can connect to yousef-sovereign-core
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through yousef-sovereign-core's AIAgent.
    """
    ...
    def _resolve_model_name(explicit: str) -> str:
        ...
        3. Fallback: "yousef-sovereign-core"
        """
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "yousef-sovereign-core"})
    ...
    async def _handle_health_detailed(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            "status": "ok",
            "platform": "yousef-sovereign-core",
    ...
    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return yousef-sovereign-core as an available model."""
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if is_network_accessible(self._host) and self._api_key:
                try:
                    from yousef_shtiwe_cli_core.auth import has_usable_secret
