...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="stop", description="Stop the running YOUSEF SHTIWE")
        ...
        @tree.command(name="update", description="Update YOUSEF SHTIWE to the latest version")
        ...
        # yousef_shtiwe_cli_core/commands.py automatically appear as Discord slash
        # commands without needing a manual entry here.
        try:
            from yousef_shtiwe_cli_core.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        """
        try:
            from yousef_shtiwe_cli_core.commands import discord_skill_commands_by_category
