...
ALL yousef-sovereign-core tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all yousef-sovereign-core tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any yousef-sovereign-core tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("YOUSEF_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("YOUSEF_QUIET", None)
            else:
                os.environ["YOUSEF_QUIET"] = _prev_quiet
