...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from YOUSEF SHTIWE"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from YOUSEF SHTIWE",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from YOUSEF SHTIWE",
    },
    {
...
class TerminalTestEnv(YousefShtiweBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/yousef-sovereign-core/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="SovereignCore/q-30b-t-h45-e1",
            tool_call_parser="yousef",
