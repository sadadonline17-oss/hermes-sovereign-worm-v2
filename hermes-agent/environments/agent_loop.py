"""
YousefShtiweLoop -- Reusable Multi-Turn Agent Engine

Runs the yousef-sovereign-core tool-calling loop using standard OpenAI-spec tool calling.
...
identical to yousef-sovereign-core's run_agent.py. Tool execution is dispatched via
...
# Resized at runtime by YousefShtiweBaseEnv.__init__ via resize_tool_pool().
...
def resize_tool_pool(max_workers: int):
    ...
    Called by YousefShtiweBaseEnv.__init__ based on config.tool_pool_size.
...
class YousefShtiweLoop:
    """
    Runs yousef-sovereign-core's tool-calling loop using standard OpenAI-spec tool calling.
    ...
    async def run(self, messages: List[Dict[str, Any]]) -> AgentResult:
        ...
        for turn in range(self.max_turns):
            ...
            # yousef-sovereign-core's standalone parsers. This handles the case where
            ...
            if (
                ...
                try:
                    ...
                    fallback_parser = get_parser("yousef")
            ...
            if assistant_msg.tool_calls:
                ...
                # Execute each tool call via yousef-sovereign-core's dispatch
