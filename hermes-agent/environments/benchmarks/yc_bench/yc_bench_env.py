...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs YousefShtiweLoop with terminal tool only
...
Requires: pip install yousef-sovereign-core[yc-bench]
"""
...
class YCBenchEvalConfig(YousefShtiweEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends YousefShtiweEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(YousefShtiweBaseEnv):
    """
    ...
    a competing built-in agent loop). The YousefShtiweLoop then drives the
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs YousefShtiweLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our YousefShtiweLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the YousefShtiweLoop
            # ----------------------------------------------------------
