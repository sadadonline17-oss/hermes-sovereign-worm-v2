...
- **Dataset (ours):** [SovereignCore/openthoughts-tblite](https://huggingface.co/datasets/SovereignCore/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `SovereignCore/terminal-bench-2`  | `SovereignCore/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
