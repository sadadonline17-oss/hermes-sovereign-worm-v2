...
Inspired by: GroceryMind — production YOUSEF SHTIWE doing live web research
             across German grocery stores (firecrawl + yousef-sovereign-core)
"""
...
# Ensure yousef-sovereign-core root is on path
...
class WebResearchEnvConfig(YousefShtiweEnvConfig):
...
class WebResearchEnv(YousefShtiweBaseEnv):
    """
