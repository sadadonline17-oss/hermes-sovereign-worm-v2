...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "yousef", "mistral", "llama3_json")
...
from environments.tool_call_parsers.yousef_parser import HermesToolCallParser  # noqa: E402, F401
