...
class HermesSweEnv(YousefShtiweBaseEnv):
    ...
    def config_init(cls) -> Tuple[HermesSweEnvConfig, List[APIServerConfig]]:
        ...
        env_config = HermesSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="SovereignCore/DeepHermes-3-Llama-3-3B-Preview",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="SovereignCore/DeepHermes-3-Llama-3-3B-Preview",
