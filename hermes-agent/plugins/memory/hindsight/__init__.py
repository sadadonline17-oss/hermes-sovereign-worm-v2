...
Or via $YOUSEF_HOME/hindsight/config.json (profile-scoped), falling back to
...
def _load_config() -> dict:
    ...
    Resolution order:
      1. $YOUSEF_HOME/hindsight/config.json  (profile-scoped)
    ...
    return {
        ...
        "banks": {
            "yousef": {
                "bankId": os.environ.get("HINDSIGHT_BANK_ID", "yousef"),
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._retain_context = "conversation between YOUSEF SHTIWE and the User"
    ...
    def save_config(self, values, hermes_home):
        """Write config to $YOUSEF_HOME/hindsight/config.json."""
        import json
        from pathlib import Path
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from yousef_shtiwe_cli_core.memory_setup import _curses_select
        ...
        provider_config["bank_id"] = "yousef"
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "bank_id", "description": "Memory bank name", "default": "yousef"},
            ...
            {"key": "retain_context", "description": "Context label for retained memories", "default": "conversation between YOUSEF SHTIWE and the User"},
        ...
        if self._client is None:
            if self._mode == "local_embedded":
                ...
                logger.debug("Creating HindsightEmbedded client (profile=%s, provider=%s)",
                             self._config.get("profile", "yousef"), llm_provider)
                kwargs = dict(
                    profile=self._config.get("profile", "yousef"),
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        banks = self._config.get("banks", {}).get("yousef", {})
        self._bank_id = self._config.get("bank_id") or banks.get("bankId", "yousef")
        ...
        self._retain_context = self._config.get("retain_context", "conversation between YOUSEF SHTIWE and the User")
