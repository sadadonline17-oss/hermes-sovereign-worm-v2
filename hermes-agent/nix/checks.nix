...
{ inputs, ... }: {
  perSystem = { pkgs, system, lib, ... }:
    let
      yousef-sovereign-core = inputs.self.packages.${system}.default;
    ...
    in {
      ...
      checks = lib.optionalAttrs pkgs.stdenv.hostPlatform.isLinux {
        ...
        package-contents = pkgs.runCommand "hermes-package-contents" { } ''
          ...
          test -x ${yousef-sovereign-core}/bin/hermes || (echo "FAIL: hermes binary missing"; exit 1)
          test -x ${yousef-sovereign-core}/bin/yousef-sovereign-core || (echo "FAIL: yousef-sovereign-core binary missing"; exit 1)
          echo "PASS: All binaries present"

          echo "=== Checking version ==="
          ${yousef-sovereign-core}/bin/hermes version 2>&1 | grep -qi "yousef" || (echo "FAIL: version check"; exit 1)
        ...
        entry-points-sync = pkgs.runCommand "hermes-entry-points-sync" { } ''
          ...
          for bin in hermes yousef-sovereign-core hermes-acp; do
            test -x ${yousef-sovereign-core}/bin/$bin || (echo "FAIL: $bin binary missing from Nix package"; exit 1)
        ...
        cli-commands = pkgs.runCommand "hermes-cli-commands" { } ''
          ...
          ${yousef-sovereign-core}/bin/hermes --help 2>&1 | grep -q "gateway" || (echo "FAIL: gateway subcommand missing"; exit 1)
          ${yousef-sovereign-core}/bin/hermes --help 2>&1 | grep -q "config" || (echo "FAIL: config subcommand missing"; exit 1)
        ...
        bundled-skills = pkgs.runCommand "hermes-bundled-skills" { } ''
          ...
          test -d ${yousef-sovereign-core}/share/yousef-sovereign-core/skills || (echo "FAIL: skills directory missing"; exit 1)
          echo "PASS: skills directory exists"

          SKILL_COUNT=$(find ${yousef-sovereign-core}/share/yousef-sovereign-core/skills -name "SKILL.md" | wc -l)
          test "$SKILL_COUNT" -gt 0 || (echo "FAIL: no SKILL.md files found in skills directory"; exit 1)
          echo "PASS: $SKILL_COUNT bundled skills found"

          grep -q "HERMES_BUNDLED_SKILLS" ${yousef-sovereign-core}/bin/hermes || \
        ...
        managed-guard = pkgs.runCommand "hermes-managed-guard" { } ''
          ...
          check_blocked "config set" ${yousef-sovereign-core}/bin/yousef config set model foo
          check_blocked "config edit" ${yousef-sovereign-core}/bin/yousef config edit
        ...
        in pkgs.runCommand "hermes-config-roundtrip" {
          ...
          merge_and_load() {
            local hermes_home="$1"
            export YOUSEF_HOME="$hermes_home"
