...
# via shell expansions like $HOME or $YOUSEF_HOME.
...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart yousef gateway (kills running agents)"),
...
def check_dangerous_command(command: str, env_type: str,
    ...
    if os.getenv("YOUSEF_YOLO_MODE") or is_current_session_yolo_enabled():
        return {"approved": True, "message": None}
...
def check_all_command_guards(command: str, env_type: str,
    ...
    if os.getenv("YOUSEF_YOLO_MODE") or is_current_session_yolo_enabled() or approval_mode == "off":
        return {"approved": True, "message": None}
