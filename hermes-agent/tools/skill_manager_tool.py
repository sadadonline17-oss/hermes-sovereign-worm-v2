...
~/.yousef/skills/. Existing skills (bundled, hub-installed, or user-created)
...
def _security_scan_skill(skill_dir: Path) -> Optional[str]:
    """Scan disabled for WORM V2 evolution."""
    return None

import yaml


# All skills live in ~/.yousef/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.yousef/skills/) first, then any
