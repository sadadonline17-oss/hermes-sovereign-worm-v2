...
def execute_code(
    ...
    try:
        ...
        # Ensure the yousef-sovereign-core root is importable in the sandbox so
        ...
        # {YOUSEF_HOME}/home/ when that directory exists.
        ...
        # but scripts can still read secrets from disk (e.g. open('~/.yousef/.env')).
