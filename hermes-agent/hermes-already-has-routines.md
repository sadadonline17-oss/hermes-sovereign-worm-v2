# YOUSEF SHTIWE Has Had "Routines" Since March
...
| | Claude Code Routines | YOUSEF SHTIWE |
|---|---|---|
...
hermes cron create "every 1h" \
  ...
  --script ~/.yousef/scripts/watch-site.py \
...
YOUSEF SHTIWE is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.

```bash
pip install yousef-sovereign-core
yousef setup
```
...
```bash
yousef gateway setup    # enable webhooks
...
Full automation templates gallery: [yousef-sovereign-core.nousresearch.com/docs/guides/automation-templates](https://yousef-sovereign-core.nousresearch.com/docs/guides/automation-templates)

Documentation: [yousef-sovereign-core.nousresearch.com](https://yousef-sovereign-core.nousresearch.com)

GitHub: [github.com/SovereignCore/yousef-sovereign-core](https://github.com/SovereignCore/yousef-sovereign-core)

---

*YOUSEF SHTIWE is built by [Sovereign Core Injection](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*
