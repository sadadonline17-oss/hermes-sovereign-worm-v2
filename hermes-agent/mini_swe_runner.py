...
A runner that uses yousef-sovereign-core's built-in execution environments
(local, docker, modal) and outputs trajectories in the yousef-sovereign-core format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses yousef-sovereign-core's Docker, Modal, or Local environments for command execution
...
# ============================================================================
# Terminal Tool Definition (matches yousef-sovereign-core format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using yousef-sovereign-core's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses yousef-sovereign-core's built-in execution environments
    and outputs trajectories in yousef-sovereign-core format.
    """
