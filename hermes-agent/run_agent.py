...
class _SafeWriter:
    ...
    When yousef-sovereign-core runs as a systemd service, Docker container, or headless
...
class AIAgent:
    ...
    def __init__(
        ...
        # both live under ~/.yousef/logs/.  Idempotent, so gateway mode
        # (which creates a new AIAgent per message) won't duplicate handlers.
        from yousef_logging import setup_logging, setup_verbose_logging
        ...
        if self.verbose_logging:
            ...
            if self.quiet_mode:
                ...
                for quiet_logger in [
                    ...
                    'yousef_shtiwe_cli_core',           # CLI helpers
                ]:
        ...
        if self.api_mode == "anthropic_messages":
            ...
            try:
                from yousef_shtiwe_cli_core.config import load_config as _load_br_cfg
            ...
            if api_key and base_url:
                ...
                if "openrouter" in effective_base.lower():
                    client_kwargs["default_headers"] = {
                        "HTTP-Referer": "https://yousef-sovereign-core.nousresearch.com",
                        "X-OpenRouter-Title": "YOUSEF SHTIWE",
                        "X-OpenRouter-Categories": "productivity,cli-agent",
                    }
                elif "api.githubcopilot.com" in effective_base.lower():
                    from yousef_shtiwe_cli_core.models import copilot_default_headers
                ...
                if _routed_client is not None:
                    ...
                    if _explicit and _explicit not in ("auto", "openrouter", "custom"):
                        ...
                        raise RuntimeError(
                            ...
                            f"variable, or switch to a different provider with `yousef model`."
                        )
                    # No provider configured — reject with a clear message.
                    raise RuntimeError(
                        "No LLM provider configured. Run `yousef model` to "
                        "select a provider, or run `yousef setup` for first-time "
                        "configuration."
                    )
        ...
        # Session logs go into ~/.yousef/sessions/ alongside gateway sessions
        ...
        if self._session_db:
            try:
                self._session_db.create_session(
                    ...
                    source=self.platform or os.environ.get("YOUSEF_SESSION_SOURCE", "cli"),
                    model=self.model,
                    model_config={
        ...
        try:
            from yousef_shtiwe_cli_core.config import load_config as _load_agent_config
            ...
            try:
                ...
                if not _mem_provider_name:
                    try:
                        ...
                        if _hcfg.enabled and (_hcfg.api_key or _hcfg.base_url):
                            ...
                            try:
                                from yousef_shtiwe_cli_core.config import load_config as _lc, save_config as _sc
                                _cfg = _lc()
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        from yousef_constants import get_hermes_home as _ghh
                        _init_kwargs = {
                            "session_id": self.session_id,
                        ...
                        try:
                            ...
                            _init_kwargs["agent_workspace"] = "yousef"
                        except Exception:
                            pass
        ...
        if _engine_name != "compressor":
            ...
            if _selected_engine is None:
                try:
                    from yousef_shtiwe_cli_core.plugins import get_plugin_context_engine
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"by YOUSEF SHTIWE.  Choose a model with at least "
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        import logging
        import re as _re
        from yousef_shtiwe_cli_core.providers import determine_api_mode
    ...
    def _vprint(self, *args, force: bool = False, **kwargs):
        ...
        parseable single-query flows such as ``yousef chat -q``. In that mode,
        ...
        try:
            ...
            if client is None or not aux_model:
                msg = (
                    ...
                    "Run `yousef setup` or set OPENROUTER_API_KEY."
                )
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from yousef_shtiwe_cli_core.models import _should_use_copilot_responses_api
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        if not self.skip_context_files:
            ...
            # mode).  The gateway process runs from the yousef-sovereign-core install
        ...
        from yousef_time import now as _hermes_now
        now = _hermes_now()
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            from yousef_shtiwe_cli_core.auth import resolve_nous_runtime_credentials
    ...
    def _try_activate_fallback(self) -> bool:
        ...
        try:
            ...
            try:
                from yousef_shtiwe_cli_core.model_normalize import normalize_model_for_provider
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if self._is_qwen_portal():
            api_kwargs["metadata"] = {
                "sessionId": self.session_id or "yousef",
        ...
        if _is_nous:
            extra_body["tags"] = ["product=yousef-sovereign-core"]
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if "models.github.ai" in self._base_url_lower or "api.githubcopilot.com" in self._base_url_lower:
            try:
                from yousef_shtiwe_cli_core.models import github_model_reasoning_efforts
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        try:
            from yousef_shtiwe_cli_core.plugins import get_pre_tool_call_block_message
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        try:
            ...
            if _is_nous:
                summary_extra_body["tags"] = ["product=yousef-sovereign-core"]
    ...
    def run_conversation(
        ...
        from yousef_logging import set_session_context
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if (
                        ...
                        print(f"{self.log_prefix}     • Legacy cleanup: yousef config set ANTHROPIC_TOKEN \"\"")
                        print(f"{self.log_prefix}     • Clear stale keys: yousef config set ANTHROPIC_API_KEY \"\"")
                    ...
                    if is_client_error:
                        ...
                        if classified.is_auth or classified.reason == FailoverReason.billing:
                            if _provider == "openai-codex" and status_code == 401:
                                ...
                                self._vprint(f"{self.log_prefix}      • Is the key valid? Run: yousef setup", force=True)
