...
description: "Run Sovereign-Sovereign directly on an Android phone with Termux"
---

# Sovereign on Android with Termux

This is the tested path for running Sovereign-Sovereign directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop Sovereign from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

Sovereign now ships a Termux-aware installer path:
...
Or set keys directly in `~/.yousef/.env`.
...
### `yousef doctor` says ripgrep or Node is missing
