...
description: "Reference for Sovereign core, composite, platform, and dynamic toolsets"
---
...
```bash
yousef chat --toolsets web,file,terminal
yousef chat --toolsets debugging        # composite — expands to file + terminal + web
yousef chat --toolsets all              # everything
```
...
| `code_execution` | `execute_code` | Run Python scripts that call Sovereign tools programmatically. |
