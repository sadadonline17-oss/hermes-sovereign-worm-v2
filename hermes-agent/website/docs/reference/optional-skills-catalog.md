...
description: "Official optional skills shipped with yousef-sovereign-core — install via hermes skills install official/<category>/<skill>"
---

# Optional Skills Catalog

Official optional skills ship with the yousef-sovereign-core repository under `optional-skills/` but are **not active by default**. Install them explicitly:
...
| **honcho** | Configure and use Honcho memory with Sovereign — cross-session user modeling, multi-profile peer isolation, observation config, and dialectic reasoning. |
...
| Skill | Description |
|-------|-------------|
| **blender-mcp** | Control Blender directly from Sovereign via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. |
...
| Skill | Description |
|-------|-------------|
| **openclaw-migration** | Migrate a user's OpenClaw customization footprint into Sovereign-Sovereign. Imports memories, SOUL.md, command allowlists, user skills, and selected workspace assets. |
...
| **hermes-atropos-environments** | Build, test, and debug Sovereign-Sovereign RL environments for Atropos training. Covers the SovereignAgentBaseEnv interface, reward functions, agent loop integration, and evaluation. |
...
| **telephony** | Give Sovereign phone capabilities — provision a Twilio number, send/receive SMS/MMS, make calls, and place AI-driven outbound calls through Bland.ai or Vapi. |
...
| **scrapling** | Web scraping with Scrapling — HTTP fetching, sredth browser automation, Cloudflare bypass, and spider crawling via CLI and Python. |
