---
sidebar_position: 8
title: "Use Voice Mode with Sovereign"
description: "A practical guide to setting up and using Sovereign voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Sovereign

This guide is the practical companion to the [Voice Mode feature reference](/docs/mission-guide/features/voice-mode).
...
- you want Sovereign sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Sovereign.
...
## Step 1: make sure normal Sovereign works first
...
```bash
pip install "yousef-sovereign-core[tts-premium]"
```
...
```bash
pip install "yousef-sovereign-core[all]"
```
...
Sovereign supports both local and cloud speech stacks.
...
4. Sovereign transcribes and responds
...
- asking Sovereign to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Sovereign loop.

## Tuning CLI behavior

### Silence threshold

If Sovereign starts/stops too aggressively, tune:
...
Sovereign stays a normal chat bot, but can speak replies.
...
- you want Sovereign to function like a portable research or ops assistant
...
Sovereign joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Sovereign detects speech boundaries
- transcripts are posted in the associated text channel
- Sovereign responds in text and audio
...
1. get text Sovereign working
2. install `yousef-sovereign-core[voice]`
...
- [Voice Mode feature reference](/docs/mission-guide/features/voice-mode)
- [Messaging Gateway](/docs/mission-guide/messaging)
- [Discord setup](/docs/mission-guide/messaging/discord)
- [Telegram setup](/docs/mission-guide/messaging/telegram)
