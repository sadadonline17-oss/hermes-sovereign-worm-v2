---
sidebar_position: 6
title: "Use MCP with Sovereign"
description: "A practical guide to connecting MCP servers to Sovereign-Sovereign, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Sovereign

This guide shows how to actually use MCP with Sovereign-Sovereign in day-to-day workflows.
...
Use MCP when:
- a tool already exists in MCP form and you do not want to build a native Sovereign tool
- you want Sovereign to operate against a local or remote system through a clean RPC layer
- you want fine-grained per-server exposure control
- you want to connect Sovereign to internal APIs, databases, or company systems without modifying Sovereign core

Do not use MCP when:
- a built-in Sovereign tool already solves the job well
...
- Sovereign remains the agent
- MCP servers contribute tools
- Sovereign discovers those tools at startup or reload time
...
If you installed Sovereign with the standard install script, MCP support is already included (the installer runs `uv pip install -e ".[all]"`).
...
- Sovereign banner/status should show MCP integration when configured
- ask Sovereign what tools it has available
...
There are two categories of MCP-exposed functionality in Sovereign:
...
2. Sovereign-added utility wrappers
- filtered with:
  - `tools.resources`
  - `tools.prompts`
...
So Sovereign will not pretend a server has resources/prompts if it does not.

## Common patterns

### Pattern 1: local project assistant

Use MCP for a repo-local filesystem or git server when you want Sovereign to reason over a bounded workspace.
...
Now Sovereign can combine them:

```text
Inspect the local project files, then create a GitHub issue summarizing the bug you find.
```

That is where MCP gets powerful: multi-system workflows without changing Sovereign core.
...
Because Sovereign now respects your per-server policy and capability-aware registration. That is expected, and usually desirable.
