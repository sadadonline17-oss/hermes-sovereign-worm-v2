...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Sovereign-Sovereign — schemas, handlers, registration, and toolsets"
---
...
If your tool requires an API key, add it to `yousef_shtiwe_cli_core/config.py`:
...
- [ ] Optional: API key added to `OPTIONAL_ENV_VARS` in `yousef_shtiwe_cli_core/config.py`
- [ ] Optional: Added to `toolset_distributions.py` for batch processing
- [ ] Tested with `yousef chat -q "Use the weather tool for London"`
