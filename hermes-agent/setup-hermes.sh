...
# 5. Symlinks the 'yousef' CLI command into a user-facing bin dir
...
echo ""
echo -e "${CYAN}☠ YOUSEF SHTIWE Setup${NC}"
echo ""
...
# ============================================================================
# Seed bundled skills into ~/.yousef/skills/
# ============================================================================

HERMES_SKILLS_DIR="${YOUSEF_HOME:-$HOME/.yousef}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.yousef/skills/ ..."
...
if is_termux; then
    echo "  yousef gateway       # Run gateway in foreground"
else
    echo "  yousef gateway install # Install gateway service (messaging + cron)"
fi
echo "  hermes cron list     # View scheduled jobs"
echo "  yousef doctor        # Diagnose issues"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m yousef_shtiwe_cli_core.main setup
fi
